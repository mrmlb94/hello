...
class CombinedE2ETest {
    ...
    void testSignup() {
        ...
        String expectedUrl = "http://localhost:8081/signup";
    ...
    void testQuizAndLogout() {
        driver.get("http://localhost:8081/quiz");
        ...
        boolean urlChanged = wait.until(ExpectedConditions.urlToBe("http://localhost:8081/login"));
        assertTrue(urlChanged, "URL did not change to the expected login page");
    }

    @Test
    void testUserFlow() {
        driver.get("http://localhost:8081/users");
